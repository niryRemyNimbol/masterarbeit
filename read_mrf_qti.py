...
data_path = '../recon_q_examples/data/Exam52006/Series3/recon_data'
mask_path = '../recon_q_examples/data/Exam52006/Series3/mask.dat'
map_path = '../recon_q_examples/data/Exam52006/Series3/qmaps.dat'
#data_path = '../recon_q_examples/data/recon_data'
mrf = read_mrf_data(data_path, 260, 256)
series = mrf.reshape((260, 256**2))
