...
def plot_brain_results_len(length):
    ...
    if length > 0:
        axlen_t1[0].set_title(r'\textbf{T1 (ms), }' + '{}'.format(length + 1) + r'\textbf{ time steps}')
        axlen_t1[1].set_title(r'\textbf{T1 percentage error, }' + '{}'.format(length + 1) + r'\textbf{ time steps}')
        axlen_t1[2].set_title(r'\textbf{T1 scatter plot, }' + '{}'.format(length + 1) + r'\textbf{ time step}')
    else:
        axlen_t1[0].set_title(r'\textbf{T1 (ms), }' + '{}'.format(length + 1) + r'\textbf{ time step}')
        axlen_t1[1].set_title(r'\textbf{T1 percentage error, }' + '{}'.format(length + 1) + r'\textbf{ time step}')
        axlen_t1[2].set_title(r'\textbf{T1 scatter plot, }' + '{}'.format(length + 1) + r'\textbf{ time step}')
    ...
    if length > 0:
        axlen_t2[0].set_title(r'\textbf{T2 (ms), }' + '{}'.format(length + 1) + r'\textbf{ time steps}')
        axlen_t2[1].set_title(r'\textbf{T2 percentage error, }' + '{}'.format(length + 1) + r'\textbf{ time steps}')
        axlen_t2[2].set_title(r'\textbf{T2 scatter plot, }' + '{}'.format(length + 1) + r'\textbf{ time step}')
    else:
        axlen_t2[0].set_title(r'\textbf{T2 (ms), }' + '{}'.format(length + 1) + r'\textbf{ time step}')
        axlen_t2[1].set_title(r'\textbf{T2 percentage error, }' + '{}'.format(length + 1) + r'\textbf{ time step}')
        axlen_t2[2].set_title(r'\textbf{T2 scatter plot, }' + '{}'.format(length + 1) + r'\textbf{ time step}')
